...
Namespace WindowsApplication1
	Partial Public Class Form1
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			schedulerStorage1.Appointments.Add(New Appointment(AppointmentType.Normal, DateTime.Today, DateTime.Today, "test" & Environment.NewLine & "test test test" & Environment.NewLine & "Test teste teste") With {.ResourceId = 1})
		...
		Private Sub MyMenuItemClick(ByVal sender As Object, ByVal e As EventArgs)
			...
			Dim selectedResource As Resource = TryCast((CType(sender, DevExpress.Utils.Menu.DXMenuItem)).Tag, Resource)
